...
import { UserDecryptMultiple } from "../types";

/**
 * @title UserDecryptMultiple Tests
 * @notice Comprehensive tests for UserDecryptMultiple contract
...
describe("UserDecryptMultiple", function () {
  ...
  async function deployContractFixture() {
    ...
    const ContractFactory = await hre.ethers.getContractFactory("UserDecryptMultiple");
    ...
    await hre.fhevm.assertCoprocessorInitialized(contract, "UserDecryptMultiple");
